...
func main() {
	...
	planService := service.NewPlanService(planRepo, pondRepo, readingRepo, restrictionService, auditService)
	executionService := service.NewExecutionService(executionRepo, planRepo, pondRepo, readingRepo, restrictionService, auditService)
